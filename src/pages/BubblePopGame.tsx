    ...
    <div style={{
      ...
      <button
        ...
        style={{
          ...
          fontFamily: 'Boldonse, sans-serif', fontWeight: 700, fontSize: '1rem', color: '#4f46e5',
      ...
      <div style={{
        ...
        fontFamily: 'Boldonse, sans-serif', fontSize: '1.5rem', fontWeight: 700, color: '#312e81',
        boxShadow: '0 4px 16px rgba(0,0,0,0.1)',
      }}>
        🎯 {score} pontos
      </div>
      ...
      <p style={{
        ...
        color: 'rgba(79,70,229,0.2)', fontSize: '3rem', fontWeight: 900, whiteSpace: 'nowrap',
      ...
      <button
        ...
        style={{
          ...
          borderRadius: '9999px',
          background: 'radial-gradient(circle at 35% 35%, rgba(255,255,255,0.6), rgba(79,70,229,0.7) 70%, rgba(109,40,217,0.9))',
